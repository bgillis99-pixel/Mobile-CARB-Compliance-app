...
const App: React.FC = () => {
  ...
  return (
    <div className="dark min-h-screen bg-carb-navy text-white overflow-x-hidden selection:bg-carb-accent">
        ...
        <header className="pt-safe px-6 py-4 fixed top-0 left-0 right-0 glass-dark z-[100] border-b border-white/5">
          <div className="flex justify-between items-center w-full max-w-md mx-auto">
            <button onClick={() => setCurrentView(AppView.LANDING)} className="h-10 px-4 rounded-xl metallic-silver transition-all active:scale-95 border-white/40 shadow-md flex items-center justify-center">
              <span className="text-[10px] font-black uppercase tracking-widest text-[#020617] italic leading-none">HOME</span>
            </button>
        ...
        <main className={`flex-1 overflow-y-auto pt-28 pb-32`}>
            <div className="px-6">
